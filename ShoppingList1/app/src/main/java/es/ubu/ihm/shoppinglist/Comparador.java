...
public class Comparador extends AppCompatActivity {
    ...
    public void pasoElegida1(View v) {
        Intent intent = new Intent (v.getContext(), Elegida1.class);
        startActivityForResult(intent, 0);
    }

    public void pasoElegida2(View v) {
        Intent intent = new Intent (v.getContext(), Elegida2.class);
        startActivityForResult(intent, 0);
    }

    public void pasoElegida3(View v) {
        Intent intent = new Intent (v.getContext(), Elegida3.class);
        startActivityForResult(intent, 0);
    }
}

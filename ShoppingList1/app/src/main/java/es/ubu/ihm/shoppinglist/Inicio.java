...
public class Inicio extends AppCompatActivity {
    ...
    public void pasoOfertas(View v) {
        Intent intent = new Intent (v.getContext(), Ofertas.class);
        startActivityForResult(intent, 0);
    }


    public void pasoCompra(View v) {
        Intent intent = new Intent (v.getContext(), Compras.class);
        startActivityForResult(intent, 0);
    }
